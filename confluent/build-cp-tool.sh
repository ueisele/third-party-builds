...
function usage () {
    echo "$0: $1" >&2
    echo
    echo "Usage: CONFLUENT_GIT_REPO=https://github.com/confluentinc/rest-utils.git BUILD=7.2.0 MAVEN_REPO_ID=confluent-snapshots::default::\${MAVEN_URL} SHOULD_PUBLISH=true $0"
    echo
    return 1
}
