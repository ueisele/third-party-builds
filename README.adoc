...
.To install a Snapshot version of Apache's Kafka Streams 3.0.0 with Gradle
[source,groovy]
----
compile group: 'org.apache.kafka', name: 'kafka-streams', version: '3.0.0-SNAPSHOT'
----

.To install a Snapshot version of Confluent's Kafka Streams 7.0.0 with Gradle
[source,groovy]
----
compile group: 'org.apache.kafka', name: 'kafka-streams', version: '7.0.0-ccs-SNAPSHOT'
----

.To install a Snapshot version of Confluent's Kafka Avro Serializer 7.0.0 with Gradle
[source,groovy]
----
compile group: 'io.confluent', name: 'kafka-avro-serializer', version: '7.0.0-SNAPSHOT'
----
